# Calculation of aroon indicator. Calculates for every day the distance to the 
# last high / low day in the lookback period. If today is a new high in the look back
# period, the indicator is 100.
